...
namespace Coherence.Generated
{
	...
	public struct Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321 : ICoherenceComponentData
	{
		...
		{
			var other = (Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321)data;
			if ((mask & 0x01) != 0)
			{
				Frame = other.Frame;
		...
		public static void Serialize(Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321 data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.agentTypeID, _agentTypeID_Min, _agentTypeID_Max, "Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321.agentTypeID");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.walkableMask, _walkableMask_Min, _walkableMask_Max, "Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321.walkableMask");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.areaMask, _areaMask_Min, _areaMask_Max, "Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321.areaMask");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.avoidancePriority, _avoidancePriority_Min, _avoidancePriority_Max, "Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321.avoidancePriority");
		...
		public static (Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321, uint, uint?) Deserialize(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321();
		...
		public static (Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321, uint, uint?) DeserializeArchetypeEnemy_8e3461cf8d4e4834688cfb7eaef98857_Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321();
			if (bitStream.ReadMask())
		...
		{
			var last = lastSent as Enemy_id3_UnityEngine__char_46_AI__char_46_NavMeshAgent_5713996564709775321?;
