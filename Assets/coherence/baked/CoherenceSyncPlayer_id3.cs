...
namespace Coherence.Generated
{
	...
	public class CoherenceSyncPlayer_id3 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncPlayer_id3>();
		}
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncPlayer_id3] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
