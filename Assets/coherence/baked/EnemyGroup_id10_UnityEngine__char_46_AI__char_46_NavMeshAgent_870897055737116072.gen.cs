...
namespace Coherence.Generated
{
	...
	public struct EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072 : ICoherenceComponentData
	{
		...
		{
			var other = (EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072)data;
			if ((mask & 0x01) != 0)
			{
				Frame = other.Frame;
		...
		public static void Serialize(EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072 data, uint mask, IOutProtocolBitStream bitStream)
		{
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.agentTypeID, _agentTypeID_Min, _agentTypeID_Max, "EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072.agentTypeID");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.walkableMask, _walkableMask_Min, _walkableMask_Max, "EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072.walkableMask");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.areaMask, _areaMask_Min, _areaMask_Max, "EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072.areaMask");
			...
			if (bitStream.WriteMask((mask & 0x01) != 0))
			{
				Coherence.Utils.Bounds.Check(data.avoidancePriority, _avoidancePriority_Min, _avoidancePriority_Max, "EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072.avoidancePriority");
		...
		public static (EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072, uint, uint?) Deserialize(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072();
		...
		public static (EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072, uint, uint?) DeserializeArchetypeEnemyGroup_dc358293f079f194ab5ec7d1d043818f_EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072_LOD0(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072();
			if (bitStream.ReadMask())
		...
		{
			var last = lastSent as EnemyGroup_id10_UnityEngine__char_46_AI__char_46_NavMeshAgent_870897055737116072?;
