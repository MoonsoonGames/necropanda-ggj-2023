...
namespace Coherence.Generated
{
	...
	public struct EnemyGroup_id10_Health_7876943199613064705 : ICoherenceComponentData
	{
		...
		{
			var other = (EnemyGroup_id10_Health_7876943199613064705)data;
			if ((mask & 0x01) != 0)
			{
				Frame = other.Frame;
		...
		public static void Serialize(EnemyGroup_id10_Health_7876943199613064705 data, uint mask, IOutProtocolBitStream bitStream)
		{
		...
		public static (EnemyGroup_id10_Health_7876943199613064705, uint, uint?) Deserialize(InProtocolBitStream bitStream)
		{
			var mask = (uint)0;
			var val = new EnemyGroup_id10_Health_7876943199613064705();
		...
		{
			var last = lastSent as EnemyGroup_id10_Health_7876943199613064705?;
